...
- `../css/docgen.css`: generated with `tailwindcss@3.4.17` from `../css/tailwind-source.css` and `templates/**/*.html`; SHA-256 `d0eff50bd3810001d6c40a0d47efe8446f7ef50cd613a396dfad5dfc92ef4c69`; MIT license in `TAILWIND-LICENSE.txt`.
